export const COPY = {
  fr: {
    ...
    labels: {
      ...
      boundaryCopy:
        "C12 expose l’authentification, l’auto-use et la readiness du provider verrouillé. Discovery, le bail contrôleur et ResourceGuard restent UNKNOWN car C12 ne les expose pas indépendamment.",
  ...
  en: {
    ...
    labels: {
      ...
      boundaryCopy:
        "C12 exposes authentication, auto-use, and locked-provider readiness. Discovery, controller lease, and ResourceGuard remain UNKNOWN because C12 does not expose them independently.",
...
export const GATE_COPY = {
  ...
  resource_admissible: { fr: "Ressource admissible", en: "Resource admissible" },
